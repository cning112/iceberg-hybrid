...
/**
 * Unique identifier for a table metadata commit in the global catalog.
 * Each commit represents a specific version of table metadata (schema, partitioning, etc.).
 * Commit IDs are globally unique and monotonically increasing per table.
 * 

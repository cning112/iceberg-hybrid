...
/**
 * Represents a request to commit new metadata to the global catalog.
 * Contains all changes that need to be atomically applied to create a new
 * table version. Must be approved by all required regions before committing.
 */
@Value
...
public class CommitRequest {
    ...
    public String toString() {
        return "CommitRequest{" +
               ...
               ", operation='" + operation + '\'' +
               ", newDataFileCount=" + newDataFiles.size() +
               '}';
    }
}
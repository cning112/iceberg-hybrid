...
/**
 * Represents a geographic region in the distributed Iceberg system.
 * Each region has its own storage, compute, and replication capabilities.
 * Regions participate in distributed consensus for write operations.
 * 

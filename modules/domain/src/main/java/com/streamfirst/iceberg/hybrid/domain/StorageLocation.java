...
/**
 * Represents a storage endpoint in a specific region. Each region can have multiple storage
 * locations for different purposes (primary data, backup, temporary files, etc.).
 *

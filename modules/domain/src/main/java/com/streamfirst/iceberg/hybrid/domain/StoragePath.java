...
/**
 * Value object representing a storage path with validation and operations. Ensures path consistency
 * across different storage backends and operating systems.
 */

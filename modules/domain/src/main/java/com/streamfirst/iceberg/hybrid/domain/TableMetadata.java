...
/**
 * Represents a specific version of Apache Iceberg table metadata.
 * Contains all information needed to describe the table's structure and data files
 * at a particular point in time. Metadata is versioned by commit ID and replicated
 * across regions for geo-distributed access.
 */
@Value

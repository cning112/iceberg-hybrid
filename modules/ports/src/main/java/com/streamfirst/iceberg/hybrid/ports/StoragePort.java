 ...
 * (S3, MinIO, HDFS, etc.) behind a uniform interface.
 */
public interface StoragePort {
  ...
  /**
   * Opens a stream for reading file content. Preferred method for large files.
   *
   * @param location the storage location
   * @param path the file path to read
  ...
  /**
   * Copies a file between storage locations. Supports cross-region copying for data replication.
   *
  ...
  /**
   * Lists files matching the specified criteria. Provides flexible file filtering for complex
   * storage scenarios.
   *
   * @param location the storage location
